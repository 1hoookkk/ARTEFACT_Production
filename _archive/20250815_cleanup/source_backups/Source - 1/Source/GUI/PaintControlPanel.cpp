...
void PaintControlPanel::buttonClicked(juce::Button* button)
{
    ...
    {
        currentBrushType = 0;  // SineBrush
        updateBrushButtons();
    }
    else if (button == &harmonicBrushButton)
    {
        currentBrushType = 1;  // HarmonicBrush
        updateBrushButtons();
    }
    else if (button == &noiseBrushButton)
    {
        currentBrushType = 2;  // NoiseBrush
        updateBrushButtons();
    }
    else if (button == &sampleBrushButton)
    {
        currentBrushType = 3;  // SampleBrush
        updateBrushButtons();
    }
    else if (button == &granularBrushButton)
    {
        currentBrushType = 4;  // GranularPen
        updateBrushButtons();
    }
    else if (button == &cdpMorphButton)
    {
        currentBrushType = 5;  // CDPMorph
        updateBrushButtons();
    }
...
void PaintControlPanel::updateBrushButtons()
{
    ...
    sineBrushButton.setToggleState(currentBrushType == 0, juce::dontSendNotification);
    harmonicBrushButton.setToggleState(currentBrushType == 1, juce::dontSendNotification);
    noiseBrushButton.setToggleState(currentBrushType == 2, juce::dontSendNotification);
    sampleBrushButton.setToggleState(currentBrushType == 3, juce::dontSendNotification);
    granularBrushButton.setToggleState(currentBrushType == 4, juce::dontSendNotification);
    cdpMorphButton.setToggleState(currentBrushType == 5, juce::dontSendNotification);
}
...
juce::Font PaintControlPanel::createModernFont(float size) const
{
    ...
    return juce::Font(size, juce::Font::FontStyleFlags::plain)
