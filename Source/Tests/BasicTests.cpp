...
#include "../Core/PluginProcessor.h"  // Add processor for constructor test
...
public:
    ...
    void runTest() override
    {
        ...
        // CRITICAL CRASH DIAGNOSIS: Test processor constructor in isolation
        beginTest("Processor Constructor Isolation");
        {
            logMessage("Testing ARTEFACTAudioProcessor constructor...");
            
            try {
                auto* processor = new ARTEFACTAudioProcessor();
                expect(processor != nullptr, "Processor should construct without crash");
                
                logMessage("Constructor succeeded - testing destructor...");
                delete processor;
                
                expect(true, "Processor constructor/destructor cycle completed");
