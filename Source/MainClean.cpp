...
public:
    ...
    {
        // 🚨 CRITICAL FIX: Initialize Config system BEFORE creating any components
        SpectralCanvas::Config::InitializeFromCommandLine(commandLine.toUTF8());
        
        DBG("🔧 SpectralCanvas Application: Config initialized, Mode=" << 
            SpectralCanvas::Config::GetConfigurationSummary());
