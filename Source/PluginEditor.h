...
private:
    ...
    std::unique_ptr<HudOverlay> hudOverlay;
    juce::TextButton testButton {"Test"};
    
    // Heartbeat Slice - Paint-to-Audio Controls
    juce::Slider cpsSlider {"CPS"};
    juce::Slider gammaSlider {"Gamma"};
    juce::Slider topNSlider {"TopN"};
    juce::Label cpsLabel {"", "Speed (CPS)"};
    juce::Label gammaLabel {"", "Brightness"};
    juce::Label topNLabel {"", "Density"};
